...
default source, and silences it while you hold a global push-to-talk key — so when
you PTT in your comms app, your dictation software and everything else go quiet.
...
smr set-key            # press the key you want as push-to-talk
```
...
Bind the **same** physical key as both your comms app's PTT and `smr`'s key: holding
...
physical mic, `wpctl` manages the default source and the mute, and PTT is read
